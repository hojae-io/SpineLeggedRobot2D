...
%% Parameter vector
params   = [m0 m1 m2 m3 m4 I0 I1 I2 I3 I4 Ir N l_Of_m1 l_Bf_m2 l_Af_m3 l_Cf_m4 l_O_Of l_Of_Af l_Of_Bf l_Af_Cf l_Df_Ef g]';
q_max_val = [ 1e6  1e6  1e6  pi/2  -pi/12  pi/2  -pi/12  pi/2];
q_min_val = [-1e6 -1e6 -1e6 -pi/2 -5*pi/6 -pi/2 -5*pi/6 -pi/2];
joint_idx = [4 5 6 7];

tau_max_val = 3;
tau_min_val = -3;

q_dim = 7;                  % Number of generalized coordinates
z_init = [0; 0.17; 0; pi/4; -pi/2; pi/4; -pi/2;
          0; 0; 0; 0; 0; 0; 0;];
